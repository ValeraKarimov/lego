...
carouselCont.addEventListener('click', function (e) {
	...
	if (e.target.className == 'item') {
		...
		textureImg = e.target.getAttribute('data-texture');
...
function init() {
	...
	cubeMaterial = new THREE.MeshLambertMaterial( { color: 0xfeb74c, map: new THREE.TextureLoader().load( 'img/square-outline-textured.png' ) } ); 
